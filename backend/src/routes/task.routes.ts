 ...
 */
router.post('/', handleAuth(createTask));
 ...
 *         description: Unauthorized
 */
router.get('/', handleAuth(getTasks));
 ...
 *         description: Unauthorized
 */
router.get('/:id', handleAuth(getTaskById));
 ...
 *         description: Unauthorized
 */
router.put('/:id', handleAuth(updateTask));
 ...
 *         description: Unauthorized
 */
router.delete('/:id', handleAuth(deleteTask));
